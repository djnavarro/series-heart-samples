...
# function
flame19 <- function(seed, fname = NULL, layers = 3, iter = 3000000, box = 2){
  ...
  pal <- scico::scico(256, palette = "grayC", alpha = .1, 
                      )  # originally .02
  #bg <- "#101010"
  bg <- "#ffffff"
  ...
  if(is.null(fname)) { fname <- paste0(prefix, "_", seed, "b.png") }
